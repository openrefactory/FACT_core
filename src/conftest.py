...
def analysis_plugin(request, monkeypatch, patch_cfg):
    ...
    * plugin_start_worker: If set the AnalysisPluginClass.start method will be called.
    * plugin_init_kwargs: Additional keyword arguments that shall be passed to the ``AnalysisPluginClass`` constructor
    ...
    .. Note::
        ...
        If you want to use the ``plugin_start_worker`` marker and want to modify plugin configuration like for example TIMEOUT
